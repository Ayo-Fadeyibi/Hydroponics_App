...
## TomatoGrowthModel.pkl

A Lasso Regression model used to predict expected fruit weight conditional on growth occurring.
...
prob_model = joblib.load(TomatoProbabilityModel.pkl)
growth_model = joblib.load(TomatoGrowthModel.pkl)
